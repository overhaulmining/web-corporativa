            ...
            <div className="bg-gray-900 text-white text-xs w-full">
                <div className="flex justify-between items-center max-w-6xl m-auto">
                    <div className="flex gap-5">
                        ...
                        <div className="space-x-1">
                            <svg className="inline-block h-5" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><g fill="none" stroke="currentColor" ><circle cx="12" cy="12" r="9" /><path d="M11 8v5h5" /></g></svg>
                            <span className="inline-block">
                                Lun - Sab: 9:00 - 18:30
                            </span>
                        </div>
