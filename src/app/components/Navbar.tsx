            ...
            <div className="bg-gray-900 text-white text-xs w-full px-5 ">
                <div className="flex justify-between items-center max-w-6xl m-auto py-1">
                    ...
                    <div className={`flex gap-5 ${isMenuOpen ? "block" : "hidden"} md:flex text-center` }>
                        <Link href="https://www.facebook.com/overhaulmining.eirl" target='blanck'  className="hover:bg-[#067AA1] p-2 rounded-lg transition duration-200">
                        ...
                        <Link href="https://www.youtube.com/channel/UCe22YT4KMpgPUw6-hLwVYKA?view_as=subscriber" target='blanck' className="hover:bg-[#067AA1] p-2 rounded-lg transition duration-200">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                                <g fill="none" >
                        ...
                        <Link href="https://www.linkedin.com/in/overhaul-mining-eirl-908b04191/recent-activity/all/" target='blanck' className="hover:bg-[#067AA1] p-2 rounded-lg transition duration-200">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                                <path fill="currentColor" d="M19 3a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2zm-.5 15.5v-5.3a3.26 3.26 0 0 0-3.26-3.26c-.85 0-1.84.52-2.32 1.3v-1.11h-2.79v8.37h2.79v-4.93c0-.77.62-1.4 1.39-1.4a1.4 1.4 0 0 1 1.4 1.4v4.93zM6.88 8.56a1.68 1.68 0 0 0 1.68-1.68c0-.93-.75-1.69-1.68-1.69a1.69 1.69 0 0 0-1.69 1.69c0 .93.76 1.68 1.69 1.68m1.39 9.94v-8.37H5.5v8.37z" />
                            </svg>
                        </Link>
                        <Link href="https://www.instagram.com/overhaulmining/?hl=es-la" target='blanck' className="hover:bg-[#067AA1] p-2 rounded-lg transition duration-200">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
